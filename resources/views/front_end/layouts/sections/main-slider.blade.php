<section id="slider-container" class="slider-area two">
    <div class="slider-owl owl-theme owl-carousel">
        ...
        <div class="single-slide item"
            style="background-image: url('{{ asset('front_end_links/eduhome/img/slider/slider3.jpg') }}')">
            <!-- Start Slider Content -->
            <div class="slider-content-area">
                <div class="container">
                    <div class="row">
        ...
        <!-- Start Slingle Slide -->
        <div class="single-slide item"
            style="background-image: url('{{ asset('front_end_links/eduhome/img/slider/slider1.jpg') }}')">
            <!-- Start Slider Content -->
            <div class="slider-content-area">
                <div class="container">
                    <div class="row">
